...
<template>
 ...
 class="block text-xs text-cyber-neon-cyan"
    ...
    <textarea
      ...
      :value="modelValue"
 class="block w-full resize-none rounded-hud border bg-cyber-glass px-3 py-2 text-xs text-cyber-text backdrop-blur-md transition-all duration-300 placeholder:text-cyber-muted focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-cyber-bg disabled:cursor-not-allowed disabled:opacity-40"
      :class="
        error
