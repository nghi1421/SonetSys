...
<template>
 ...
 class="absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-cyber-neon-pink px-1 text-xs font-bold text-white shadow-pink-glow"
    >
