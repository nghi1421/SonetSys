...
return Application::configure(basePath: dirname(__DIR__))
    ...
    // Not passed to withRouting()'s own `channels:` param — that registers
    // /broadcasting/auth with the default `web` middleware group (session
    // guard), which never authenticates this SPA's Bearer-token users.
    // withBroadcasting() lets us pin the correct guard instead.
    ->withBroadcasting(
