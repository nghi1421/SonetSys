...
final class AdminAdCampaignResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'advertiser' => [
                'id' => $this->whenLoaded('advertiser', fn () => $this->advertiser->id),
                'name' => $this->whenLoaded('advertiser', fn () => $this->advertiser->name),
                'email' => $this->whenLoaded('advertiser', fn () => $this->advertiser->email),
            ],
